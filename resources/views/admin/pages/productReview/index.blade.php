                                ...
                                @foreach ($reviews as $review)
                                        ...
                                        <td>
                                            <img class="w-50px h-50px"
                                                src="{{ asset('storage/' . $review->thumbnail) }}"
                                                alt="{{ $review->name }}"
                                                onerror="this.onerror=null; this.src='{{ asset('frontend/img/no-blogs.jpg') }}';">
                                        </td>
                                        <td>{{ $review->name }}</td>
                                        <td class="text-center">
                                            @if ($review->box_stock > 0)
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="15"
                                                        height="15" x="0" y="0" viewBox="0 0 512 512"
                                                        style="enable-background:new 0 0 512 512" xml:space="preserve"
                                                        class="">
                                                        <g>
                                                            <path
                                                                d="M448 330.07V112a8.011 8.011 0 0 0-4.42-7.16l-192-96a8.018 8.018 0 0 0-6.93-.1l-208
                                            ...
                                            @else
                                                <span title="No Box Stock">
                                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                        ...
                                                        height="40" x="0" y="0" viewBox="0 0 60 60"
                                                        style="enable-background:new 0 0 512 512" xml:space="preserve"
                                                        class="">
                                                        <g>
                                                            <path
                                        ...
                                        <td>
                                            <span
                                                ...
                                                {{ $review->status == 'published' ? 'Published' : 'Unpublished' }}</span>
                                        </td>
                                        <td class="text-center">
