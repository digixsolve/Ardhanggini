<x-admin-app-layout :title="'Testimonial Edit'">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <form class="form" action="{{ route('admin.testimonial.update', $testimonial->id) }}"
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-7">
                                    ...
                                    <x-metronic.input id="name" type="text" name="name" :value="old('name', $testimonial->name)"
                                ...
                                <div class="col-lg-6 mb-7">
                                    ...
                                    <x-metronic.input id="company_name" type="text" name="company_name"
                                        :value="old('company_name', $testimonial->company_name)" placeholder="Enter the Company"></x-metronic.input>
                                </div>
                                ...
                                <div class="col-lg-4 mb-7">
                                    ...
                                    <x-metronic.select-option id="rating" name="rating" data-hide-search="true"
                                        ...
                                        <option></option>
                                        <option value="1" @selected(old('rating', $testimonial->rating) == '1')>1</option>
                                        <option value="2" @selected(old('rating', $testimonial->rating) == '2')>2</option>
                                        <option value="3" @selected(old('rating', $testimonial->rating) == '3')>3</option>
                                        <option value="4" @selected(old('rating', $testimonial->rating) == '4')>4</option>
                                        <option value="5" @selected(old('rating', $testimonial->rating) == '5')>5</option>
                                ...
                                <div class="col-lg-12 mb-7">
                                    ...
                                    <x-metronic.textarea id="message"
                                        name="message">{{ $testimonial->message }}</x-metronic.textarea>
                                </div>
