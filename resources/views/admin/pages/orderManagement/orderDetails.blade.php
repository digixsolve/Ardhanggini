    ...
    <div class="d-flex flex-column flex-column-fluid mt-5">
        ...
        <div id="kt_app_content" class="app-content  flex-column-fluid ">
            <div id="kt_app_content_container" class="app-container container-fluid">
                <div class="row mb-10">
                    <div class="col-xl-3 card card-flush py-4 flex-row-fluid">
                    ...
                    <div class="col-xl-4 card card-flush py-4 flex-row-fluid">
                        <div class="card-header">
                            <div class="card-title">
                    ...
                    <div class="col-xl-5 card card-flush py-4 flex-row-fluid">
                        <div class="card-header">
                            <div class="card-title">
