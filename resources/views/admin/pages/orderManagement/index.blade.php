                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @elseif ($order->status == 'delivered')
                                        <span class="badge py-3 px-4 fs-7 badge-light-info">Delivered</span>
                                    @elseif ($order->status == 'cancelled')
                                        <span class="badge py-3 px-4 fs-7 badge-light-danger">Cancelled</span>
                                    @elseif ($order->status == 'returned')
                                        <span class="badge py-3 px-4 fs-7 badge-light-danger">Returned</span>
                                    @endif
                                </td>
                                <td>
                                    <button
                                    ...
                                    <div class="modal fade" id="changeDeliveryStatus-{{ $order->id }}"
                                        tabindex="-1" aria-labelledby="changeDeliveryStatusLabel" aria-hidden="true">
