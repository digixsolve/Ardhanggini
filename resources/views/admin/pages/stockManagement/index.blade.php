                                                    ...
                                                    <div class="row">
                                                        ...
                                                        {{-- <div class="mb-7 col-4">
                                                            ...
                                                            <x-metronic.input type="number" name="box_contains"
                                                                id="box_contains" class="mb-2 form-control box_contains"
                                                        ...
                                                        {{-- <div class="mb-7 col-4">
                                                            ...
                                                            <x-metronic.input type="number" name="unit_price"
                                                                id="unit_price" class="mb-2 form-control unit_price"
                                                        ...
                                                        <div class="mb-7 col-4">
                                                            ...
                                                            <x-metronic.input type="number" name="unit_discount_price"
                                                                id="unit_discount_price" class="mb-2 form-control unit_discount_price"
                                                        ...
                                                        <div class="mb-7 col-4">
                                                            <x-metronic.label class="form-label">Unit
                                                                Price</x-metronic.label>
                                                            <x-metronic.input type="number" name="unit_price"
                                                                id="unit_price" class="mb-2 form-control"
                                                        ...
                                                        <div class="mt-5 mb-7 col-lg-6">
                                                            ...
                                                            <x-metronic.input type="number" name="box_stock"
                                                                id="box_stock" class="mb-2 form-control"
