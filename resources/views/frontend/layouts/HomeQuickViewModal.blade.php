                                ...
                                <div class="col-12 col-xl-6 pr-0">
                                    <div class="ps-product__info mb-0">
                                        ...
                                        <div class="ps-product__branch pt-2">
                                            <a href="#" style="text-transform: uppercase;">{{ optional($latest_product->brand)->name }}</a>
                                        </div>
                                        <h4 class="">
                                                ...
                                                <div class="ps-product__feature">
                                                    @if (!empty($latest_product->unit_discount_price))
                                                        <div class="ps-product__meta py-3">
                                                            <span
                                                                class="ps-product__price sale">৳{{ $latest_product->unit_discount_price }}</span>
                                                            <span class="ps-product__del">৳{{ $latest_product->unit_price }}</span>
                                                        </div>
                                                    @else
                                                        <div class="ps-product__meta py-3">
                                                            <span class="ps-product__price sale">৳{{ $latest_product->unit_price }}</span>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="ps-product__quantity">
                                                        ...
                                                        <div class="def-number-input number-input safari_only">
                                                            ...
                                                            <input class="quantity" min="1" name="quantity" value="1"
                                                                type="number" data-product_id="{{ $latest_product->id }}" />
                                                            <button class="plus"
                                                                onclick="this.parentNode.querySelector('input[type=number]').stepUp()"><i
                                                                    class="icon-plus"></i></button>
                                                        </div>
                                                    ...
                                                    <a class="ps-btn ps-btn--warning add_to_cart_btn_product_single"
                                                        data-product_id="{{ $latest_product->id }}" href="#">Add to cart</a>
                                                </div>
                                                ...
                                                <div class="ps-product__feature">
                                                    @if (!empty($deal_product->stock) && $deal_product->stock > 0)
                                                        <div class="ps-product__badge mb-0"><span
                                                                class="ps-badge bg-success">{{ $deal_product->stock }} In Stock</span></div>
                                                    @else
                                                    ...
                                                    @else
                                                        <div class="ps-product__meta py-3">
                                                            <span class="ps-product__price sale">৳{{ $deal_product->unit_price }}</span>
                                                        </div>
                                                    @endif
                                                        ...
                                                        <div class="def-number-input number-input safari_only">
                                                            <button class="minus"
                                                                onclick="this.parentNode.querySelector('input[type=number]').stepDown()"><i
                                                                    class="icon-minus"></i></button>
                                                            <input class="quantity" min="1" name="quantity" value="1"
                                                                type="number" data-product_id="{{ $deal_product->id }}" />
                                                            <button class="plus"
                                                                onclick="this.parentNode.querySelector('input[type=number]').stepUp()"><i
                                                                    class="icon-plus"></i></button>
                                                        </div>
                                                    ...
                                                    <a class="ps-btn ps-btn--warning add_to_cart_btn_product_single"
                                                        data-product_id="{{ $deal_product->id }}" href="#">Add to cart</a>
