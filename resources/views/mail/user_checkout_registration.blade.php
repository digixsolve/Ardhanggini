        ...
        <tbody>
            ...
            <tr>
                <td align="left" valign="center">
                    <div
                        ...
                        <div style="padding-bottom: 30px">Welcome to {{ optional($setting)->website_name }}! We're
                        ...
                        <div style="padding-bottom: 30px">
                            Thank you for registering with {{ optional($setting)->website_name }}! Your account is
                            currently pending approval. We will review your information and notify you as soon as your
                            account is activated. The below your login credential is given to login to your dashboard.
                        </div>
                        <div style="padding-bottom: 30px">
                            Click this <a href="https://www.ardhanggini.com/dashboard">URL (https://www.ardhanggini.com/login)</a> to go to your dashboard.
                        </div>
                        ...
                        <div style="padding-bottom: 30px">
                            ...
                            <a href="{{ route('contact') }}" rel="noopener" target="_blank"
                                style="text-decoration:none;color: #009EF7">{{ optional($setting)->website_name }}
                                Contact</a>.
                        </div>
                        <!--end:Email content-->
                        <div style="padding-bottom: 10px">Sincerely,<br>The {{ optional($setting)->website_name }} Team.
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td align="center" valign="center"
                    ...
                    <p>Copyright © <a href="{{ route('home') }}" rel="noopener"
                            target="_blank">{{ optional($setting)->website_name }}</a>.</p>
                </td>
            </tr>
        </tbody>
    </table>
